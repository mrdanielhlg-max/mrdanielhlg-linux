...
import com.mrdanielhlg.linux.shared.reflection.ReflectionUtils;
...
public class TermuxUtils {
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.mrdanielhlg.linux.shared.R.raw.apt_info_script);
        try {

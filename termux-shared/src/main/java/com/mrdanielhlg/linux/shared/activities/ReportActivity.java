package com.mrdanielhlg.linux.shared.activities;
...
import com.mrdanielhlg.linux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.mrdanielhlg.linux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.mrdanielhlg.linux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }

...
import com.mrdanielhlg.linux.app.event.SystemEventReceiver;
import com.mrdanielhlg.linux.app.terminal.TermuxTerminalSessionActivityClient;
import com.mrdanielhlg.linux.app.terminal.TermuxTerminalSessionServiceClient;
import com.mrdanielhlg.linux.shared.termux.plugins.TermuxPluginUtils;
import com.mrdanielhlg.linux.shared.data.IntentUtils;
import com.mrdanielhlg.linux.shared.net.uri.UriUtils;
import com.mrdanielhlg.linux.shared.errors.Errno;
import com.mrdanielhlg.linux.shared.shell.ShellUtils;
import com.mrdanielhlg.linux.shared.shell.command.runner.app.AppShell;
import com.mrdanielhlg.linux.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.mrdanielhlg.linux.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.mrdanielhlg.linux.shared.termux.shell.TermuxShellUtils;
...
import com.mrdanielhlg.linux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.mrdanielhlg.linux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.mrdanielhlg.linux.shared.termux.shell.TermuxShellManager;
import com.mrdanielhlg.linux.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.mrdanielhlg.linux.shared.termux.terminal.TermuxTerminalSessionClientBase;
import com.mrdanielhlg.linux.shared.logger.Logger;
import com.mrdanielhlg.linux.shared.notification.NotificationUtils;
...
import com.mrdanielhlg.linux.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.mrdanielhlg.linux.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.mrdanielhlg.linux.shared.R.string.error_execution_cancelled))) {
